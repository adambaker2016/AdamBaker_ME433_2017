...
/** Hello World-LCD!
  ...
  @Summary
 Provides a template file for writing characters
  @Description
...
int main() {
    ...
    while(1) {
        ...
        if(_CP0_GET_COUNT()>9600000){
            ...
            sprintf(message, "Hello World! %d   ",help);
            write_word(26,32,message);
            i = 0;
            for(i; i<=5; i++) {
                make_line(5+help+i,60,MAGENTA);
            }
