...
extern char rx[64]; // the raw data
extern int rxPos; // how much data has been stored
extern int gotRx; // the flag
extern int rxVal; // a place to store the int that was received
            ...
            if (appData.isReadComplete == true) {
                ...
                while (appData.readBuffer[ii] != 0) {
                    ...
                    if (appData.readBuffer[ii] == '\n' || appData.readBuffer[ii] == '\r') {
                        ...
                        //got new information -? use to tell servo motor what to do
                        ...
                        // set servo to appropriate angle
                        OC3RS = 3000+rxVal*3000/640; // should set the motor to 60 degrees (0.5ms to 2.5ms is 1500 to 7500 for 0 to 180 degrees)
